...
| `bare-metal-starter` | Recommended → Advanced (in progress) | [doc](./bare-metal-starter.md) | [`k8s/overlays/bare-metal-starter/`](../../k8s/overlays/bare-metal-starter/) | [png](../assets/architecture/overlay-bare-metal-starter.png) | First serious bare-metal cluster + GitOps loop |
| `home-edge-lab` | Recommended → Advanced (in progress) | [doc](./home-edge-lab.md) | [`k8s/overlays/home-edge-lab/`](../../k8s/overlays/home-edge-lab/) | [png](../assets/architecture/overlay-home-edge-lab.png) | Pi + NAS home lab with IoT, cameras, family-chat agent |
